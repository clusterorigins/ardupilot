#include "AP_MagTest_Params.h"
#include "AP_MagTest.h"

// table of user settable parameters
const AP_Param::GroupInfo AP_MagTest_Params::var_info[] = {
    // @Param: TYPE
    ...
    // @User: Standard
    AP_GROUPINFO_FLAGS("TYPE", 1, AP_MagTest_Params, type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @User: Standard
    AP_GROUPINFO("PIN",     2, AP_MagTest_Params, pin, -1),
    ...
    // @Increment: 0.001
    // @User: Standard
    AP_GROUPINFO("SCALING", 3, AP_MagTest_Params, scaling, 3.0f),
    ...
    // @Increment: 0.001
    // @User: Standard
    AP_GROUPINFO("OFFSET",  4, AP_MagTest_Params, offset, 0.0f),
    ...
    // @User: Standard
    AP_GROUPINFO("FUNCTION", 5, AP_MagTest_Params, function, 0),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MIN_CM",  6, AP_MagTest_Params, min_distance_cm, 20),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MAX_CM",  7, AP_MagTest_Params, max_distance_cm, 700),
    ...
    // @User: Standard
    AP_GROUPINFO("STOP_PIN", 8, AP_MagTest_Params, stop_pin, -1),
    ...
    // @Values: 0:No,1:Yes
    // @User: Standard
    AP_GROUPINFO("RMETRIC", 10, AP_MagTest_Params, ratiometric, 1),
    ...
    // @Range: 0 32767
    // @User: Standard
    AP_GROUPINFO("PWRRNG", 11, AP_MagTest_Params, powersave_range, 0),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("GNDCLEAR", 12, AP_MagTest_Params, ground_clearance_cm, RANGEFINDER_GROUND_CLEARANCE_CM_DEFAULT),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("ADDR", 23, AP_MagTest_Params, address, 0),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("POS", 49, AP_MagTest_Params, pos_offset, 0.0f),
    ...
    // @User: Advanced
    AP_GROUPINFO("ORIENT", 53, AP_MagTest_Params, orientation, ROTATION_PITCH_270),
